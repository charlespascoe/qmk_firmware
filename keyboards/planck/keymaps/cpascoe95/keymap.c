...
[_BASE] = LAYOUT_planck_grid(
    KC_GRV,  KC_W,    KC_F,    KC_R,          _______, BAL,           BAR,     _______, KC_I,          KC_L,    KC_Y,    CUST_BSPC,
...
[_BASE_ALT_LEFT] = LAYOUT_planck_grid(
    ...
    _______, LSFT(KC_SCOLON), KC_V,    KC_B,    _______, _______, _______, _______, _______, _______, _______, _______,
...
[_BASE_ALT_RIGHT] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_P,    KC_SCOLON, _______,        _______,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DOT,  KC_CIRC, KC_DOLLAR, KC_EQUAL, _______, _______, _______, _______, LCTL(KC_L), KC_LBRC, KC_RBRC, _______,
    _______, _______, _______,   _______,  _______, _______, _______, _______, _______,    _______, _______, _______
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_PERC, LSFT(KC_TAB), KC_TAB,  _______, _______, _______, _______, KC_DOWN, KC_UP,   KC_RIGHT, KC_BSLS,
