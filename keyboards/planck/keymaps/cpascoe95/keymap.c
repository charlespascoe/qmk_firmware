...
[_BASE] = LAYOUT_planck_grid(
    KC_GRV,  KC_W,    KC_F,    KC_R,          _______, BAL,           BAR,     _______, KC_I,          KC_L,    KC_Y,    KC_BSPC,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    LSFT(KC_SCOLON), KC_CIRC, KC_DOLLAR, CUST_EQ, _______, _______, _______, _______, LCTL(KC_L), KC_LBRC, KC_RBRC, _______,
    _______,         _______, _______,   _______, _______, _______, _______, _______, _______,    _______, _______, _______
),
