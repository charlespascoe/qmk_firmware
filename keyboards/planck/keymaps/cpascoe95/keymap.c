...
[_BASE_ALT_RIGHT] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_P,    KC_DOT,  KC_SCOLON,       LSFT(KC_SCOLON),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_LEFT, KC_4,         KC_5,    _______, _______, _______, _______, KC_6,    KC_7,    KC_END,   _______,
    _______, _______, _______,      _______, _______, _______, _______, _______, _______, _______, _______,  _______
),
