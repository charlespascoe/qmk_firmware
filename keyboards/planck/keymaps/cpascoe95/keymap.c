...
[_RAISE] = LAYOUT_planck_grid(
    ...
    LSFT(KC_TAB), KC_PERC, KC_LEFT, KC_TAB,  _______, _______, _______, _______, KC_DOWN, KC_UP,   KC_RIGHT, KC_BSLS,
    _______,      KC_DOT,  KC_4,    KC_5,    _______, _______, _______, _______, KC_6,    KC_7,    KC_END,   KC_SLASH,
    _______,      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______
),
